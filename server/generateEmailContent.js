...
function generateEmailContent(body) {
      ...
      state, postal_code, datetime } = body;
                  ...
                  <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 20px 40px;font-family:arial,helvetica,sans-serif;" align="left">
                    ...
                    <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                      ...
                      <p style="font-size: 15px; line-height: 140%; text-align: center;"><span style="font-size: 14px; line-height: 16.8px;"><strong><span style="color: #4a4a4a; line-height: 16.8px; font-size: 14px;"><b>Photoshoot location:</b> ${street_number} ${city}, ${state} ${postal_code}</span></strong></span></p>
                        <br>
                      <p style="font-size: 15px; line-height: 140%; text-align: center;"><span style="font-size: 14px; line-height: 16.8px;"><strong><span style="color: #4a4a4a; line-height: 16.8px; font-size: 14px;"><b>Date & Time:</b> ${datetime}</span></strong></span></p>
                          <br>
